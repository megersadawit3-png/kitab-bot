...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ================================================================
        ...
        try:
            ...
            for content in contents:
                ...
                status_emoji = "✅" if content['status'] == 'approved' else ("⏳" if content['status'] == 'pending_encryption' or content['status'] == 'pending_author_approval' else "❌")
                caption = (
                    f"📌 **{content['title']}**\n"
                    f"🆔 ID: `{content['id']}`\n"
    ...
    # ================================================================
        ...
        try:
            ...
            security.validate_content_id(content_id)
    ...
    # ================================================================
        ...
        try:
            ...
            cursor.execute("""
                ...
                WHERE status IN ('pending_encryption', 'pending_author_approval')
            """)
    ...
    # ================================================================
        ...
        try:
            ...
            # ይህ በእውነተኛ ስርዓት ውስጥ የክፍያ ዓይነት መለየት አለበት
            # ለሙከራ ሁነታ የደራሲ ክፍያ ብቻ
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ================================================================
        ...
        try:
            users = db.get_all_users(limit=1000)  # ገደብ መጨመር
